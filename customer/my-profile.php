                  ...
                  <div class="col-lg-12">
                     <div class="cover-profile">
                        <div class="profile-bg-img">
                          <img class="profile-bg-img img-fluid" src="<?php echo WEBSITEURL; ?>assets/img/profile-banner-bg.png" alt="bg-img">
                           <div class="card-block user-info">
                              <div class="col-md-12 p-0">
                                 <div class="media-left">
                                    <div class="profile-image">
                                    <?php if($profile_output->data[0]->photoname != null){ ?>
                                    	    <img src="<?php echo $profile_output->data[0]->photo; ?>" class="img-fluid" alt="<?php echo $profile_output->data[0]->photoname; ?>">
                                    <?php } else { ?>
                                    	    <img src="<?php echo WEBSITEURL; ?>/images/dashboard-img/user-img.jpg" class="img-fluid" alt="<?php echo $profile_output->data[0]->photoname; ?>">
                     ...
                     <div class="col-md-12">
                        <form enctype="multipart/form-data" method='POST' id="update_user_profile">
                            ...
                            <div class="text-center">
                                <button class="btn theme-bg btn-rounded" type="submit">Update</button>
...
<div class="form-cont text-center edit-profile-cont" style="display: none;" id="edit_profile">
   ...
   <form class="form-popup-cont" enctype="multipart/form-data" method="POST" id="update_user_pic" novalidate="novalidate">
      ...
      <input id="upload_profileimage" type="file" name="upload_profileimage">
          ...
          <button type="submit" class="w-100 text-white submit_disable btn theme-bg btn-rounded">Update</button>
