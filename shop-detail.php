   ...
   <div class="container">
      <div class="row align-items-center">
         <div class="col-lg-8 col-md-7 col-sm-12 pr-1">
            <div class="gg_single_part left"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
         </div>
         <div class="col-lg-4 col-md-5 col-sm-12 pl-1">
            <div class="gg_single_part-right min"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
            <div class="gg_single_part-right min mt-2 mb-2"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
            <div class="gg_single_part-right min"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
         </div>
      </div>
   </div>
...
<div class="featured_slick_gallery gray d-block d-md-block d-lg-block d-xl-none">
   <div class="featured_slick_gallery-slide">
      <div class="featured_slick_padd"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
      <div class="featured_slick_padd"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
      <div class="featured_slick_padd"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
      <div class="featured_slick_padd"><a href="<?php echo $product_output->data[0]->product_image; ?>" class="mfp-gallery"><img src="<?php echo $product_output->data[0]->product_image; ?>" class="img-fluid mx-auto" alt="<?php echo $product_output->data[0]->product_image_name; ?>" /></a></div>
   </div>
               ...
               <div class="sider_blocks_wrap">
                  <div class="side-booking-header">
                     <div class="sb-header-left">
                        <h3 class="price">$<?php echo $product_output->data[0]->price; ?></h3>
                     </div>
                  ...
                  <div class="side-booking-body">
                     <div class="row">
                        ...
                        <div class="side-booking-foot">
                           ...
                           <h3 class="price theme-cl">$<?php echo $product_output->data[0]->price; ?></h3>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div class="sidebar_featured_property">
                     <div class="sides_list_property">
                        ...
                        <div class="sides_list_property_detail">
                           <h4><a href="<?php echo WEBSITEURL; ?>shop-detail.php">Loss vengel New Apartment</a></h4>
                     ...
                     <div class="sides_list_property">
                        ...
                        <div class="sides_list_property_detail">
                           <h4><a href="<?php echo WEBSITEURL; ?>shop-detail.php">Montreal Quriqe Apartment</a></h4>
                     ...
                     <div class="sides_list_property">
                        ...
                        <div class="sides_list_property_detail">
                           <h4><a href="<?php echo WEBSITEURL; ?>shop-detail.php">Curmic Studio For Office</a></h4>
                     ...
                     <div class="sides_list_property">
                        ...
                        <div class="sides_list_property_detail">
                           <h4><a href="<?php echo WEBSITEURL; ?>shop-detail.php">Montreal Quebec City</a></h4>
